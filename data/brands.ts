...
export const brandData: Record<string, BrandData> = {
  kent: {
    ...
    logoImage: '/assets/brands/kent-logo.jpg',
    heroImage: '/assets/brands/kent-hero.jpg',
  ...
  aquaguard: {
    ...
    logoImage: '/assets/brands/aquaguard-logo.jpg',
    heroImage: '/assets/brands/aquaguard-hero.jpg',
  ...
  pureit: {
    ...
    logoImage: '/assets/brands/pureit-logo.jpg',
    heroImage: '/assets/brands/pureit-hero.jpg',
  ...
  aosmith: {
    ...
    logoImage: '/assets/brands/aosmith-logo.jpg',
    heroImage: '/assets/brands/aosmith-hero.jpg',
  ...
  lg: {
    ...
    logoImage: '/assets/brands/lg-logo.jpg',
    heroImage: '/assets/brands/lg-hero.jpg',
